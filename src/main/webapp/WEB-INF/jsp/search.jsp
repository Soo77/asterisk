...
<link
	href="../node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css"
	rel="stylesheet">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <div class="card mb-4">
          ...
          <img class="card-img-top" src="http://placehold.it/50x50" alt="">
            <h2 class="card-title"><a href='detail?no=${member.memberNo}'>${member.name}</a></h2>
            <p class="card-text">
          <c:choose>
