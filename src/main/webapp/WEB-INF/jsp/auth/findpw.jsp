        ...
        <form action="findpw" method="post" class="form-signin">
  			<div class="card-body">
  				...
  				<div class="input-group">
  					...
  					<input type="text" placeholder="이름" name="name" id="name" class="form-control" required autofocus>
  				</div>
  				...
  				<div class="input-group">
  					...
  					<input type="text" placeholder="아이디" name="id" id="id" class="form-control" required>
  				</div>
          ...
          <div class="input-group">
            ...
            <input type="text" placeholder="이메일" class="form-control" name="mail0" id="mail0" maxlength="50" required>@
          </div>
          ...
          <div class="input-group mail1">
            ...
            <input type="text" class="form-control" name="mail1" id="mail1" value="" required>
          </div>
              ...
              <option value="">직접 입력</option>
  				...
  				<div class="this-center">
  					<div class="description">
  						<input type="button" id="ctf" onclick='ctfft()' class="btn btn-primary" value="찾기">
						</div>
					</div>
...
$("#mailselect").change(function() {
      var dd = document.getElementsByClassName("mail1")[0];
	console.log(dd)
